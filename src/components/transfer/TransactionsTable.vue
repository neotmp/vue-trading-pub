...
const { useTransaction, data, useBroker } = store()
					...
					<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
						...
						<tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
							<tr v-for="item in transactionsList" :key="item.id">
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div class="flex items-center">{{ item.currencyId }}</div>
								</td>

								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ item.direction }}</h4>
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ item.amount }}</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ item.currency }}</p> -->
									</div>
								</td>
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ item.status }}</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ item.currency }}</p> -->
									</div>
								</td>
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ item.fee }}</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ item.currency }}</p> -->
									</div>
								</td>
