...
const { useOrder, data, useBroker } = store()
const { ordersList } = useOrder()
					...
					<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
						...
						<tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
							<tr v-for="order in ordersList" :key="order.id">
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">
											{{ getOrderDirection(order.direction) }}
										</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ order.name }}</p> -->
									</div>
								</td>
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div class="flex items-center">{{ order.volume }}</div>
								</td>

								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ order.price }}</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ order.price }}</p> -->
									</div>
								</td>

								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ order.sl }}</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ order.currency }}</p> -->
									</div>
								</td>

								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ order.tp }}</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ order.currency }}</p> -->
									</div>
								</td>
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ order.ts }}</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ order.currency }}</p> -->
									</div>
								</td>
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div>
										<h4 class="text-gray-700 dark:text-gray-200">{{ order.commission }}</h4>
										<!-- <p class="text-gray-500 dark:text-gray-400">{{ order.currency }}</p> -->
									</div>
								</td>
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap space-x-1 flex justify-end">
									<RouterLink :to="`/orders/edit/${order.id}`" class="py-4"
										><EditIcon
									/></RouterLink>
									<div class="py-4"><TrashbinIcon /></div>
									<RouterLink :to="`/orders/detail/${order.id}`" class="py-4"
										><DocIcon
									/></RouterLink>

									<button
										@click="console.log('I was clicked', order.id)"
